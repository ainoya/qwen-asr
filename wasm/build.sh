...
"_qwen_wasm_embeds_from_enc_start","_qwen_wasm_embeds_from_enc_done","_qwen_wasm_embeds_from_enc_finish",
...
"_qwen_wasm_set_gpu_embedder","_qwen_wasm_embed_hook_done",
"_qwen_wasm_stream_eof","_qwen_wasm_stream_drained","_qwen_wasm_kv_is_f16","_qwen_wasm_set_gpu_resident",
